...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df.groupby(['Launch Site'], as_index=False).count()[['Launch Site', 'class']], values='class', 
        names='Launch Site', 
        title='Successful Launches Per Launch Site')
        return fig
    else:
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == entered_site].groupby(['Launch Site'], as_index=False).count()[['Launch Site', 'class']], values='class',
        names='Launch Site',
        title='Successful Launches Per Launch Site')
        return fig
